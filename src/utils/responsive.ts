import { CommonPhotoAlbumProps, ResponsiveParameter } from "../types/types";
...
export function resolveCommonProps(
  containerWidth: number | undefined,
  {
    spacing,
    padding,
    componentsProps,
    render,
  }: Pick<CommonPhotoAlbumProps, "spacing" | "padding" | "componentsProps" | "render">,
) {
  return {
